 ...
 *   - Ser el "diccionario" central de todo el proyecto: aquí se define
 *     CADA token del lenguaje y su código numérico.
 *   - Nadie más en el equipo debe inventar códigos de token en otra
 *     parte del código; todos deben venir de aquí (Tokens.RESERVADAS,
 *     Tokens.codigo(...), etc.) para que no haya inconsistencias entre
 *     el autómata, la matriz y la tabla final.
 *
 * Qué falta por hacer / a revisar con el equipo:
 *   - CONFIRMAR el operador lógico "or": el PDF trae "II" (probablemente
 *     un error de OCR de "||"). Confirmarlo con el profesor.
 *   - CONFIRMAR la regla exacta de identificadores: "letra + hasta 6
 *     caracteres" ¿son 6 en total o 6 además de la primera letra?
 *   - Decidir en equipo si quieren mantener este esquema de códigos
 *     (basado en rangos, como en el ejemplo del PDF) o usar otro.
 *     Aquí ya se dejó un esquema propuesto, completo y listo para usar.
 */
public class Tokens {

    // ============================================================
    // 1. PALABRAS RESERVADAS (20) -> códigos -1 a -20
    // ============================================================
     ...
     * no es una palabra reservada (en ese caso probablemente sea un
     * identificador).
     */
    ...
    /**
     * Utilidad para imprimir el nombre "legible" de un token a partir
     * de su código, útil para depurar y para generar los archivos de
     * salida con nombres en vez de solo números.
     */
